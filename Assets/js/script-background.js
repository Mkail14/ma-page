...
// Utilise le canvas existant dans le HTML au lieu d'en créer un nouveau
...
function createEyes() {
  ...
  const socketMaterial = new THREE.MeshBasicMaterial({ color: 0x000000, transparent: false });
